...
function get_file_product_info_json {
	...
	LIFERAY_COMMON_DOWNLOAD_SKIP_CACHE="true" lc_download "https://releases.liferay.com/tools/workspace/.product_info.json" "${_PROMOTION_DIR}/../.product_info.json.txt"

	cp -f "${_PROMOTION_DIR}/../.product_info.json.txt" "${_PROMOTION_DIR}/.product_info_tmp.json"
...
function get_file_release_properties {
	...
	LIFERAY_COMMON_DOWNLOAD_SKIP_CACHE="true" lc_download "https://releases.liferay.com/dxp/release-candidates/${LIFERAY_RELEASE_VERSION}-${LIFERAY_RELEASE_RC_BUILD_TIMESTAMP}/release.properties"
}
