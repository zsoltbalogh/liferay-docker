...
function build_docker_image {
	...
	DOCKER_IMAGE_TAGS=()
	DOCKER_IMAGE_TAGS+=("liferay/base:${SERVLET_IMAGE_VERSION}-${image_version}-${TIMESTAMP}")
	DOCKER_IMAGE_TAGS+=("liferay/base:${SERVLET_IMAGE_VERSION}")
	...
	docker build \
		...
		--build-arg PARENT_IMAGE="liferay/servlet:${SERVLET_IMAGE_VERSION}" \
